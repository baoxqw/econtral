...
@Form.create()
class ReimbursementRormUpdate extends PureComponent {
  state = {
    TableData:[],
    SelectValue:[],
    selectedRowKeys:[],
  ...
  componentWillReceiveProps(nextProps){
    if(nextProps.data.record.id !== this.props.data.record.id){
      ...
      //const msnTemplateHId = record.msnTemplateHId;
      if(record.finishphase){
        const finishphase = record.finishphase;
        let finishphaseId = finishphase.split(",");
        finishphaseId = finishphaseId.map(item=>{
          return Number(item)
        });
        this.setState({
          SelectManyValue:[],
          selectedRowManyKeys:finishphaseId,
        })
      }

      const travelfee = record.travelfee;
      ...
      this.setState({
        deptId,
        deptName,
        selectedRowPersonKeys:[psnId],
        SelectPersonValue:psnName,
  ...
  onSave = (onSave)=>{
    ...
    form.validateFields((err,values)=>{
      ...
      const obj = {
        ...
        //msnTemplateHId:this.state.selectedId,
  ...
  render() {
    ...
    return (
      <Modal
        ...
        footer={[
          <Button type="primary" key={2} style={{display:`${subShow?"inline-block":"none"}`}} onClick={()=>this.onSave(onSave)}>保存</Button>,
          <Button type="primary" key={3} style={{display:`${subShow?"inline-block":"none"}`}} onClick={()=>this.onsubmit(onOk)}>提交</Button>,
            ...
            <Col lg={6} md={12} sm={24}>
              <Form.Item label="总天数">
                {getFieldDecorator('totaldays',{
                  ...
                  initialValue:record.totaldays?record.totaldays:''
                })(
            ...
            <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
              <Form.Item label="交通天数">
                {getFieldDecorator('travaldays',{
                  ...
                  initialValue:record.travaldays?record.travaldays:''
            ...
            <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
              <Form.Item label="工作天数">
                {getFieldDecorator('workdays',{
                  ...
                  initialValue:record.workdays?record.workdays:''
                })(
            ...
            <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
              <Form.Item label="交通费">
                {getFieldDecorator('travelfee',{
                  ...
                  initialValue:this.state.travelfee
                })(
            ...
            <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
              <Form.Item label="补贴">
                {getFieldDecorator('subsidy', {
                  ...
                  initialValue:record.subsidy?record.subsidy:''
...
export default ReimbursementRormUpdate;
