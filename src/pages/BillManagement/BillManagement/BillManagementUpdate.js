...
@Form.create()
class BillManagementUpdate extends PureComponent {
  state = {
    dataList:{},
        ...
        callback:(res)=>{
          if(res){
            ...
            message.success("编辑成功",1,()=>{
              router.push("/billmanagement/billmanagement/list")
            })
          }
        }
      })*/
  ...
  componentWillReceiveProps(nextProps){
    if(nextProps.data.record.id !== this.props.data.record.id){
      ...
      const projectId = record.projectId; //项目id
      ...
      this.setState({
        ...
        selectedRowPersonKeys:[operatorId],
        SelectPersonValue:operatorName
      })
    }
  }
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label="发票类型">
                  {getFieldDecorator('type',{
                    ...
                    initialValue:dataList.type?dataList.type:''
              ...
              <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
                <Form.Item label="发票号">
                  {getFieldDecorator('code',{
                    ...
                    initialValue:dataList.code?dataList.code:''
                  })(
              ...
              <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
                <Form.Item label="开票日期">
                  {getFieldDecorator('invoicedate', {
                    ...
                    initialValue:dataList.invoicedate?moment(dataList.invoicedate):null
              ...
              <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
                <Form.Item label="客户打印名称">
                  {getFieldDecorator('printcustname', {
                    ...
                    //   }
                    // ],
                    initialValue:dataList.printcustname?dataList.printcustname:''
              ...
              <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
                <Form.Item label="部门">
                  {getFieldDecorator('deptId',{
                    ...
                    initialValue:this.state.departmentName?this.state.departmentName:''
                  })(<TreeSelect
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label="发票总金额">
                  {getFieldDecorator('totalsummoney',{
                    ...
                    initialValue:dataList.totalsummoney?dataList.totalsummoney:''
...
export default BillManagementUpdate;
