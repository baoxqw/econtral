...
class PersonalFileupdate extends PureComponent {
  ...
  componentDidMount() {
    ...
    if(initData.userId){
      ...
      this.setState({selectedRowKeys:[userId]})
    }
   if(initData.username){
     const userName = initData.username;
     this.setState({ SelectValue:userName})
   }
    ...
    form.validateFields((err, fieldsValue) => {
      if (!err) {
        const values = {
          reqData:{
            ...fieldsValue,
            dept_id:this.state.initData.deptId,
            id:this.state.id,
            'birthdate': fieldsValue['birthdate'].format('YYYY-MM-DD'),
            user_id:this.state.selectedRowKeys[0]?this.state.selectedRowKeys[0]:1,
          }
        };
        if(!fieldsValue.code || !fieldsValue.name
        ){
          return
        }
        dispatch({
    ...
    return (
      <PageHeaderWrapper>
        <Card title='人员档案'  bordered={false}>
          <Form layout="vertical"  onSubmit={this.validate} >
            <Row gutter={16}>
              ...
              <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
                <Form.Item label='曾用名'>
                  {form.getFieldDecorator('usedname', {
                    initialValue:initData.usedname?initData.usedname:'',
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label='紧急联系人'>
                  {getFieldDecorator('urgpsn', {
                    initialValue:initData.urgpsn?initData.urgpsn:'',
              ...
              <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
                <Form.Item label='紧急联系电话'>
                  {form.getFieldDecorator('urgphone', {
                    initialValue:initData.urgphone?initData.urgphone:'',
              ...
              <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
                <Form.Item label='手机'>
                  {form.getFieldDecorator('mobile', {
                    initialValue:initData.mobile?initData.mobile:'',
                    rules: [
              ...
              <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
                <Form.Item label='email'>
                  {form.getFieldDecorator('email', {
                    initialValue:initData.email?initData.email:'',
                    rules: [
                      {
                        type: 'email',
                        message: '邮箱格式错误!',
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label='生日'>
                  {form.getFieldDecorator('birthdate', {
                    initialValue:initData.birthdate?moment(initData.birthdate):null,
              ...
              <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
                <Form.Item label='性别'>
                  {form.getFieldDecorator('sex', {
                    initialValue:initData.sex?initData.sex:'',
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label='人员类别'>
                  {getFieldDecorator('psntype',{
                    initialValue:initData.psntype?initData.psntype:'',
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label='身份证号'>
                  {getFieldDecorator('personalid',{
                    initialValue:initData.personalid?initData.personalid:'',
                    rules:[
